...
public class ReportServiceImpl implements ReportService {
    ...
    @Override
    public List<Report> findReports4me4this(String username, String typename) {
        String sql = "select zb_id,zb_username,zb_weekduring,zb_type,zb_desc,zb_relatedurl,zb_numpercent,DATE_FORMAT(zb_onlinetime,'%Y-%m-%d') as zb_onlinetime ,zb_memo,zb_createdt,zb_updatedt\n" +
                "from qa_report\n" +
                "where zb_deleted = 0\n";
        List<Object> queryList = new ArrayList<Object>();
    ...
    public int update(Report report) {
        ...
        String sql = "update qa_report\n" +
                "set zb_weekduring = ?, zb_type=?,zb_desc=?,zb_relatedurl=?,zb_numpercent=?,zb_onlinetime=?,\n" +
                "zb_memo=?,zb_updatedt=?\n" +
                "where zb_id=?";
        return jdbcTemplate.update(sql, zb_weekduring, zb_type, zb_desc, zb_relatedurl, zb_numpercent, zb_onlinetime, zb_memo, date,id);
    }
