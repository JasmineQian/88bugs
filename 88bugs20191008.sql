...
INSERT INTO `qa_api` VALUES (36, 1, '123', '123', '123', b'0', '123', '2019-09-30 12:12:04', '2019-09-30 12:12:04');
...
INSERT INTO `qa_buglist` VALUES (88, 1, 1, '', '', 1, '', '', '', 1, 2, '2019-09-29 21:17:53', '2019-09-29 21:17:53', b'0', NULL, 1);
INSERT INTO `qa_buglist` VALUES (89, 1, 1, '', '', 1, '', '', '', 1, 2, '2019-09-29 21:19:16', '2019-09-29 21:19:16', b'0', NULL, 1);
INSERT INTO `qa_buglist` VALUES (90, 1, 1, '', '', 1, '', '', '', 1, 2, '2019-09-29 21:24:17', '2019-09-29 21:24:17', b'1', '逻辑删除', 1);
...
INSERT INTO `qa_case` VALUES (48, 0, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, '2019-09-29 20:01:16', '2019-09-29 20:01:16', b'0', NULL);
...
-- ----------------------------
INSERT INTO `qa_project` VALUES (1, '摩天轮PC端', '2018-12-21', '2018-12-21', b'0', 'alibaba.png');
INSERT INTO `qa_project` VALUES (2, '摩天轮IOS', '2018-12-21', '2018-12-21', b'0', 'tencent.jpg');
INSERT INTO `qa_project` VALUES (3, '摩天轮Andriod', '2018-12-21', '2018-12-21', b'0', 'baidu.jpg');
INSERT INTO `qa_project` VALUES (4, '摩天轮H5', '2018-12-21', '2018-12-21', b'0', 'youku.jpg');
INSERT INTO `qa_project` VALUES (5, '摩天轮后台管理', '2018-12-21', '2018-12-21', b'0', 'eleme.jpg');
INSERT INTO `qa_project` VALUES (6, 'ShowNow后台管理', '2018-12-21', '2018-12-21', b'0', 'douyin.jpg');
INSERT INTO `qa_project` VALUES (7, 'ShowNow苹果', '2018-12-21', '2018-12-21', b'0', 'kuaibo.jpg');
INSERT INTO `qa_project` VALUES (8, 'ShowNow安卓', '2018-12-21', '2018-12-21', b'0', 'kuaishou.jpg');
INSERT INTO `qa_project` VALUES (9, '卖家宝IOS', '2018-12-21', '2018-12-21', b'0', 'xiecheng.jpg');
INSERT INTO `qa_project` VALUES (10, '卖家宝Andriod', '2018-12-21', '2018-12-21', b'0', 'pingan.jpg');
INSERT INTO `qa_project` VALUES (11, '卖家宝PC端', '2018-12-21', '2018-12-21', b'0', 'taobao.jpg');
INSERT INTO `qa_project` VALUES (12, '风火轮', '2018-12-21', '2018-12-21', b'0', 'tmall.jpg');
INSERT INTO `qa_project` VALUES (13, 'OPEN_api', '2018-12-21', '2018-12-21', b'0', 'jingdong.jpg');
INSERT INTO `qa_project` VALUES (14, '活动星球', '2019-09-27', '2019-09-27', b'0', 'll.png');

-- ----------------------------
-- Table structure for qa_report
-- ----------------------------
DROP TABLE IF EXISTS `qa_report`;
CREATE TABLE `qa_report`  (
  `ZB_ID` int(4) NOT NULL AUTO_INCREMENT,
  `ZB_USERNAME` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `ZB_WEEKDURING` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `ZB_TYPE` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `ZB_DESC` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `ZB_RELATEDURL` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `ZB_DELETED` bit(1) NULL DEFAULT b'0',
  `ZB_NUMPERCENT` int(4) NULL DEFAULT NULL,
  `ZB_ONLINETIME` datetime(0) NOT NULL,
  `ZB_MEMO` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `ZB_CREATEDT` datetime(0) NOT NULL,
  `ZB_UPDATEDT` datetime(0) NOT NULL,
  PRIMARY KEY (`ZB_ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 61 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of qa_report
-- ----------------------------
INSERT INTO `qa_report` VALUES (48, '钱金燕', '2019-09-30到2019-10-06', '本周主要任务', '为新PC安装必须软件，熟悉工作环境和工作流程', 'N/A', b'0', 100, '2019-09-20 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 18:42:42');
INSERT INTO `qa_report` VALUES (49, '钱金燕', '2019-09-30到2019-10-06', '下周工作计划', '卖家宝项目跟进，熟悉业务需求，了解模块划分，准备测试计划', 'N/A', b'0', 20, '2019-10-31 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 14:03:40');
INSERT INTO `qa_report` VALUES (50, '钱金燕', '2019-09-30到2019-10-06', '本周主要任务', '完善摩天轮测监控脚本', 'http://devops.juqitech.com/jira/browse/QA-32?filter=-1', b'0', 100, '2019-09-30 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 14:06:05');
INSERT INTO `qa_report` VALUES (51, '钱金燕', '2019-09-30到2019-10-06', '本周主要任务', '完善ShowNow预约需求的C端和管理后台的测试用例', 'http://devops.juqitech.com/confluence/pages/viewpage.action?pageId=24847598', b'0', 100, '2019-09-30 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 14:07:30');
INSERT INTO `qa_report` VALUES (52, '钱金燕', '2019-09-30到2019-10-06', '本周主要任务', '编写ShowNow的C端和管理后台测试用例', 'http://devops.juqitech.com/confluence/pages/viewpage.action?pageId=24839053', b'0', 100, '2019-09-30 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 14:07:55');
INSERT INTO `qa_report` VALUES (53, '钱金燕', '2019-09-30到2019-10-06', '下周工作计划', '卖家宝项目跟进，熟悉业务需求，了解模块划分，准备测试计划', 'http://devops.juqitech.com/jira/browse/SELLER-2248', b'0', 20, '2019-10-31 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 14:08:27');
INSERT INTO `qa_report` VALUES (54, '钱金燕', '2019-09-30到2019-10-06', '本周主要任务', '完善摩天轮测监控脚本的编写，对主要的链路和逻辑进行判断', 'http://devops.juqitech.com/jira/browse/QA-32?filter=-1', b'0', 100, '2019-09-30 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 14:13:08');
INSERT INTO `qa_report` VALUES (55, '钱金燕', '2019-09-13到2019-09-27', '本周主要任务', '编写ShowNow的上线验证脚本', 'N/A', b'0', 70, '2019-09-30 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 14:14:36');
INSERT INTO `qa_report` VALUES (56, '钱金燕', '2019-09-13到2019-09-27', '本周主要任务', '摩天轮APP上线前回归测试；以及初步认识埋点测试和验证方式', 'N/A', b'0', 70, '2019-09-30 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 15:00:05');
INSERT INTO `qa_report` VALUES (57, '钱金燕', '2019-09-13到2019-09-27', '本周主要任务', '学习和了解摩天轮业务，从如何创建剧院场馆演出演出的操作，卖家报价等', 'N/A', b'0', 70, '2019-09-30 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 15:01:55');
INSERT INTO `qa_report` VALUES (58, '钱金燕', '2019-09-13到2019-09-27', '下周工作计划', '卖家宝项目跟进，熟悉业务需求，了解模块划分，准备测试计划', 'http://devops.juqitech.com/jira/browse/SELLER-2248', b'0', 70, '2019-09-30 00:00:00', '', '2019-07-30 18:12:42', '2019-09-30 15:03:28');
INSERT INTO `qa_report` VALUES (59, '钱金燕', '2019-09-29到2019-09-30', '本周主要任务', '本地Exce记录周报不方便，开发简易版在线周报功能', 'N/A', b'0', 90, '2019-09-30 00:00:00', '', '2019-09-30 18:13:39', '2019-09-30 18:19:29');
INSERT INTO `qa_report` VALUES (60, '钱金燕', '2019-09-29到2019-09-30', '下周工作计划', '卖家物流信息化的测试用例编写', 'N/A', b'0', 10, '2019-10-31 00:00:00', '', '2019-09-30 18:14:17', '2019-09-30 18:40:04');
...
CREATE TABLE `qa_user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 111131 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of qa_user
-- ----------------------------
INSERT INTO `qa_user` VALUES (2, 'admin', '$2a$10$A4EZrzoXqj4mVyXiw/fsp.mJ.Ne5aVAMWrMK0mAb2zY7lJ/H6Jryi', '钱金燕', 'role_user,role_admin', NULL, NULL);
INSERT INTO `qa_user` VALUES (111128, 'zhudaisheng', '$2a$10$eZ7JRMMjyzLA18MdorPL/.OCLAFYDPrBnSLDv8mv00Ks1FkXBAsCG', '朱代胜', 'role_user,role_admin', '2019-09-30 12:09:59', '2019-09-30 12:09:59');
INSERT INTO `qa_user` VALUES (111129, '刘胜涛', '$2a$10$L87QDocm54Bffk8t80CoAerhfcYJuPTOqyxO7KJo1.6er2ZeEJNDy', '刘胜涛', 'role_user,role_admin', '2019-09-30 12:12:13', '2019-09-30 12:12:13');
INSERT INTO `qa_user` VALUES (111130, 'zhangshuaiming', '$2a$10$dNxUHh3zSmQWBAcJmEgX3u49z9SvrlypWtWv9KVbMQvIAhNOTzyWy', '张帅铭', 'role_user,role_admin', '2019-09-30 17:31:03', '2019-09-30 17:31:03');
